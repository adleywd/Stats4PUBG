...
public class DuoStats extends AbstractStats {
    List<Stats> statsList;
    public DuoStats(List<Season> seasons, String selectedRegion){
        ...
        for (Season season : seasons) {
            ...
            if (season.getMatch().equals("duo") && season.getRegion().equals(selectedRegion)) {
