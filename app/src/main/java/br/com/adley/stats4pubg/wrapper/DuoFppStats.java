...
public class DuoFppStats extends AbstractStats {
    List<Stats> statsList;
    public DuoFppStats(List<Season> seasons, String selectedRegion){
        ...
        for (Season season : seasons) {
            ...
            if (season.getMatch().equals("duo-fpp") && season.getRegion().equals(selectedRegion)) {
